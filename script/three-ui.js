// This code comes from an npm package I made a yearish ago. It was one of my first projects
// I was having trouble actually importing the package itself so I just copy pasted the source code LOL
// check it out at https://github.com/aleguy02/3UI !
...
const shape = Cube(0xe6e6e6, true);
const scene = Scene(0x0d1117);
createScene(shape, scene, 'animation-container');
