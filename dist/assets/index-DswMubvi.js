...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:cn,depthTest:!1,depthWrite:!1})}function xa(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:cn,depthTest:!1,depthWrite:!1})}function Ma(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ls(),fragmentShader:`
...
`)}function Wf(i,e){let t;switch(e){case qo:t="Linear";break;case Yo:t="Reinhard";break;case Ko:t="Cineon";break;case Zo:t="ACESFilmic";break;case jo:t="AgX";break;case Jo:t="Neutral";break;case $o:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ki=new B;function Xf(){Ve.getLuminanceCoefficients(ki);const i=ki.x.toFixed(4),e=ki.y.toFixed(4),t=ki.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
